...
but throughout the book we will show you how the static *type system* can save us from a lot of trouble.
furthermore, a lot of optimizations are only possible because of static typing,
so static-typed languages such as C++ and Java tend to be faster then dynamically-typed languages.
...
The usage of `auto` above shows little advantage, but there are cases where using explicit type is either annoying or even impossible.
