...
export type SidebarTreeQuery = {
  allTocYaml: {
    edges: Array<{
      node: Pick<TocYaml, "title" | "url" | "upcoming"> & {
        items?: Maybe<
          Array<
            Maybe<
...
export type PageQuery = {
  mdx?: Maybe<
    Pick<Mdx, "body" | "tableOfContents"> & {
      ...
      frontmatter?: Maybe<Pick<MdxFrontmatter, "metaTitle" | "metaDescription">>;
    }
  >;
  allMdx: { edges: Array<{ node: { fields?: Maybe<Pick<MdxFields, "slug" | "title">> } }> };
  allTocYaml: {
    edges: Array<{
      node: Pick<TocYaml, "title" | "url" | "upcoming"> & {
        items?: Maybe<
