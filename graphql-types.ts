...
export type MdxFrontmatter = {
  ...
  cppreference?: Maybe<Scalars['String']>;
...
export type MdxFrontmatterFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  cppreference?: Maybe<StringQueryOperatorInput>;
  type?: Maybe<StringQueryOperatorInput>;
...
export type Query = {
  ...
  tocYaml?: Maybe<TocYaml>;
  allTocYaml: TocYamlConnection;
...
export type QueryTocYamlArgs = {
  ...
  title?: Maybe<StringQueryOperatorInput>;
  items?: Maybe<TocYamlItemsFilterListInput>;
  upcoming?: Maybe<BooleanQueryOperatorInput>;
};


export type QueryAllTocYamlArgs = {
  filter?: Maybe<TocYamlFilterInput>;
  sort?: Maybe<TocYamlSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type TocYaml = Node & {
  ...
  title?: Maybe<Scalars['String']>;
  items?: Maybe<Array<Maybe<TocYamlItems>>>;
  upcoming?: Maybe<Scalars['Boolean']>;
};

export type TocYamlConnection = {
  totalCount: Scalars['Int'];
  edges: Array<TocYamlEdge>;
  nodes: Array<TocYaml>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<TocYamlGroupConnection>;
};


export type TocYamlConnectionDistinctArgs = {
  field: TocYamlFieldsEnum;
};


export type TocYamlConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: TocYamlFieldsEnum;
};

export type TocYamlEdge = {
  next?: Maybe<TocYaml>;
  node: TocYaml;
  previous?: Maybe<TocYaml>;
};

export type TocYamlFieldsEnum = 
  | 'id'
  | 'parent___id'
  | 'parent___parent___id'
  | 'parent___parent___parent___id'
  ...
  | 'items___items___upcoming'
  | 'items___url'
  | 'items___title'
  | 'upcoming';

export type TocYamlFilterInput = {
  id?: Maybe<StringQueryOperatorInput>;
  parent?: Maybe<NodeFilterInput>;
  children?: Maybe<NodeFilterListInput>;
  internal?: Maybe<InternalFilterInput>;
...
export type TocYamlFilterListInput = {
  elemMatch?: Maybe<TocYamlFilterInput>;
};

export type TocYamlGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<TocYamlEdge>;
  nodes: Array<TocYaml>;
  pageInfo: PageInfo;
...
export type TocYamlItems = {
  upcoming?: Maybe<Scalars['Boolean']>;
  items?: Maybe<Array<Maybe<TocYamlItemsItems>>>;
  url?: Maybe<Scalars['String']>;
  title?: Maybe<Scalars['String']>;
};

export type TocYamlItemsFilterInput = {
  upcoming?: Maybe<BooleanQueryOperatorInput>;
  items?: Maybe<TocYamlItemsItemsFilterListInput>;
  url?: Maybe<StringQueryOperatorInput>;
  title?: Maybe<StringQueryOperatorInput>;
};

export type TocYamlItemsFilterListInput = {
  elemMatch?: Maybe<TocYamlItemsFilterInput>;
};

export type TocYamlItemsItems = {
  url?: Maybe<Scalars['String']>;
  title?: Maybe<Scalars['String']>;
  upcoming?: Maybe<Scalars['Boolean']>;
};

export type TocYamlItemsItemsFilterInput = {
  url?: Maybe<StringQueryOperatorInput>;
  title?: Maybe<StringQueryOperatorInput>;
  upcoming?: Maybe<BooleanQueryOperatorInput>;
};

export type TocYamlItemsItemsFilterListInput = {
  elemMatch?: Maybe<TocYamlItemsItemsFilterInput>;
};

export type TocYamlSortInput = {
  fields?: Maybe<Array<Maybe<TocYamlFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};

export type CodeBlockQueryQueryVariables = {};


export type CodeBlockQueryQuery = { glossary: { edges: Array<{ node: (
        Pick<Mdx, 'body'>
        & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'cppreference' | 'title' | 'type' | 'token'>> }
      ) }> } };

export type SidebarTreeQueryVariables = {};


export type SidebarTreeQuery = { allTocYaml: { edges: Array<{ node: (
        Pick<TocYaml, 'title' | 'url' | 'upcoming'>
        & { items?: Maybe<Array<Maybe<(
          Pick<TocYamlItems, 'url' | 'title' | 'upcoming'>
          & { items?: Maybe<Array<Maybe<Pick<TocYamlItemsItems, 'url' | 'title' | 'upcoming'>>>> }
        )>>> }
      ) }> } };
...
export type PagesQuery = { allMdx: { edges: Array<{ node: { fields?: Maybe<Pick<MdxFields, 'id' | 'slug'>> } }> } };
...
export type PageQuery = { mdx?: Maybe<(
    ...
    & { fields?: Maybe<Pick<MdxFields, 'id' | 'title' | 'slug'>>, parent?: Maybe<Pick<File, 'relativePath'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'metaTitle' | 'metaDescription'>> }
  )>, allMdx: { edges: Array<{ node: { fields?: Maybe<Pick<MdxFields, 'title' | 'pathWithoutLang'>> } }> }, allTocYaml: { edges: Array<{ node: (
        Pick<TocYaml, 'title' | 'url' | 'upcoming'>
        & { items?: Maybe<Array<Maybe<(
          Pick<TocYamlItems, 'url' | 'title' | 'upcoming'>
          & { items?: Maybe<Array<Maybe<Pick<TocYamlItemsItems, 'url' | 'title' | 'upcoming'>>>> }
